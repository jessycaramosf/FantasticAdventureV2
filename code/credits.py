...
from code.const import C_ORANGE, WIN_WIDTH, C_WHITE, C_CYAN, C_BLACK
...
class Credits:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.credit_text(18, 'Criado por: Jéssyca. C. R. Ferreira - RA: 4545764', C_BLACK,
                           (WIN_WIDTH / 2, 120))
            self.credit_text(14, 'Musica 1: Mars uk Drill instrumental, Por: prazkhanal - '
                                 'Fonte: Freesound.org', C_BLACK, (WIN_WIDTH / 2, 150))
            self.credit_text(14, 'Musica 2: Musical Composition Por: flavioconcini - '
                                 'Fonte: Freesound.org', C_BLACK,
                             (WIN_WIDTH / 2, 180))
            self.credit_text(14, 'Imagens Coletadas em CRAFTPIX.NET', C_BLACK,
                             (WIN_WIDTH / 2, 210))
            self.credit_text(18, 'OBRIGADA POR JOGAR!!!', C_BLACK,
                             (WIN_WIDTH / 2, 250))
